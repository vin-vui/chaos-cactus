        ...
        <header class="w-full  bg-slate-900 ">
                ...
                <nav class="sticky top-0 z-30">
                    <div class="flex justify-between items-center bg-zinc-800 px-12 py-2  ">
                        <div>
                            <img alt="Logo Chaos Cactus" src="/images/Ressource_perso/logo-studio/logo_pique.png"> 
                        </div>
                        <div>
                            <ul class=" flex gap-4 text-slate-300 uppercase ">
                                ...
                                <li><a class="hover:border-b border-red-800 duration-100" href="https://store.steampowered.com/">Boutique</a></li><svg class="inline-block pb-1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0,0,256,256">
                                ...
                                <li><a class="bg-red-800 px-3 py-2 uppercase border border-red-700 hover:bg-red-950 duration-100" href="{{route('contact.index')}}">Contact</a></li>
                            </ul>
                        </div>
