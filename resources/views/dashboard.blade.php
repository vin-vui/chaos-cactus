        ...
        <div class="w-screen h-screen bg-gradient-to-b from-zinc-600 via-zinc-700 to-zinc-800">
            ...
            <div>
                <div class="bg-gray-200 flex items-center gap-11 w-4/5 mx-auto mt-6 px-2 py-1 rounded-md">
                    ...
                    <div class=" w-64"> Nom : <input type="text" value="Alix" class=" h-6"></div>
                    <p class="bg-green-600 px-4 py-1 rounded-md text-white" href="">Edit</p>

                    <div class=" w-72"> Statut : <input type="text" value="Super admin" class=" h-6"></div>
                    <p class="bg-green-600 px-4 py-1 rounded-md text-white" href="">Edit</p>
                ...
                <div class="bg-gray-200 flex items-center gap-11 w-4/5 mx-auto mt-6 px-2 py-1 rounded-md">
                    <div class="h-8 w-8 rounded-full bg-red-800"></div>
                    <div class=" w-64"> Nom : <input type="text" value="Admin n°2" class=" h-6"></div>
                    <p class="bg-green-600 px-4 py-1 rounded-md text-white" href="">Edit</p>

                    <div class=" w-72"> Statut : <input type="text" value="Admin" class=" h-6"></div>
                    <p class="bg-green-600 px-4 py-1 rounded-md text-white" href="">Edit</p>
