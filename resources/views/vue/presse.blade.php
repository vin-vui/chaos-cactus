<x-guest-layout>
    <main>
        <div class="w-full h-[60vh] bg-black-wall bg-no-repeat bg-cover bg-right  flex justify-center ">
            ...
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-10 border-t-8 border-red-700 box-border  w-[95vh] text-left mt-[45vh] h-auto"
                ...
                <form class="flex flex-col">
                    ...
                    <button type="submit"
                        class="mt-10 bg-red-700 text-white p-2 rounded cursor-pointer hover:bg-red-800">Send
                        Message</button>
                </form>
            </div>
        </div>
